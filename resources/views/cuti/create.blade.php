            ...
            <form action="{{ route('cuti.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="alasan" class="form-control" rows="3"
                              placeholder="Tuliskan alasan cuti..." required>{{ old('alasan') }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="border rounded bg-light p-3 d-flex justify-content-center">
                        <canvas id="signature-pad" width="400" height="200" style="border:1px solid #ccc; background:white; border-radius:6px;"></canvas>
                    </div>
