            ...
            <form method="POST" action="{{ route('absensi.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="tanggal" class="form-control" value="{{ now()->format('d/m/Y') }}" readonly>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="badge_number" class="form-control" value="{{ Auth::user()->badge_number }}" readonly>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="time" name="waktu" class="form-control" value="{{ now()->format('H:i') }}" readonly required>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="lokasi" class="border rounded mb-3 bg-light d-flex align-items-center justify-content-center" style="height:280px;">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!fotoInput.value || fotoInput.value.trim() === '') {
            ...
            // Scroll ke foto
            ambilFotoBtn.scrollIntoView({ behavior: 'smooth', block: 'center' });
        } else {
        ...
        if (!lokasiInput.value || lokasiInput.value.trim() === '') {
            ...
            if (fotoInput.value) {
                ambilLokasiBtn.scrollIntoView({ behavior: 'smooth', block: 'center' });
            }
        } else {
