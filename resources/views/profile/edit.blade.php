                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('badge_number') is-invalid @enderror" 
                                       id="badge_number" name="badge_number" value="{{ old('badge_number', $user->badge_number) }}" required>
                                @error('badge_number')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('department') is-invalid @enderror" 
                                       id="department" name="department" value="{{ old('departement', $user->departement) }}" required>
                                @error('department')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
